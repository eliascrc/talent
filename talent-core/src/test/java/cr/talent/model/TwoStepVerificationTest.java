...
public class TwoStepVerificationTest {
    ...
    private static final String VERIFICATIONCODE1 = "code1";
    private static final String VERIFICATIONCODE2 = "code2";
    ...
    public void coreTest() {
        ...
        twoStepVerification.setVerificationCode(VERIFICATIONCODE1);
        ...
        assertEquals(VERIFICATIONCODE1, twoStepVerification.getVerificationCode());
    ...
    public void testEqualForNonPersistentTwoStepVerification() {
        ...
        twoStepVerification1.setVerificationCode(VERIFICATIONCODE1);

        TwoStepVerification twoStepVerification2 = new TwoStepVerification();
        twoStepVerification2.setResource(RESOURCE1);
        twoStepVerification2.setVerificationCode(VERIFICATIONCODE1);
    ...
    public void testNonEqualForNonPersistentTwoStepVerification() {
        ...
        twoStepVerification2.setVerificationCode(VERIFICATIONCODE2);
